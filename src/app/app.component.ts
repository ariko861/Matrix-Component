...
export class AppComponent implements OnInit {
  ...
  constructor(private synapse: SynapseService, private route: ActivatedRoute, private router: Router) { }
  ...
  ngOnInit(): void {
    if (environment.homeserver && environment.roomId) {
      ...
      this.router.navigate(
        [""],
        { queryParams: { homeserver: config.homeserver, roomId: config.roomId, mediaGallery: config.mediaGallery, fromStart: config.fromStart } }
      )
    }
